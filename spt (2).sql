...
--
-- Host: 127.0.0.1
-- Generation Time: 10 Okt 2019 pada 03.37
...
('0', 'I', 'y', '7', NULL, NULL, NULL, NULL, 2019),
...
('5d991a25e9d6f', '12', '12', 'MUHAMMAD DIS, SE', '19650401 200604 1 003', 'Pengatur II/c', 'Pengatur II/c', 'Ka. UPT Peralatan & Pengujian', 'Maksud dan tujuan spt', 'BA  8036 S', 'Ujung Gading', '2019-10-16', '2019-10-21', '2019', 'Simpang Empat', '0000-00-00', 'Ka. UPT Peralatan & Pengujian', 'MUHAMMAD DIS, SE', 'Pengatur II/c', '19650401 200604 1 003', 'DPA Dinas Pekerjaan Umum & Penataan Ruang Kab. Pasaman Barat Tahun Anggaran 2019', '', '2019-10-06 05:33:09', '2019-10-07 00:20:36', 'Simpang Empat', '0000-00-00', 'MUHAMMAD DIS, SE', '19650401 200604 1 003', 'Pengatur II/c', 'Ka. UPT Peralatan & Pengujian', 0000),
...
INSERT INTO `spt_pengikut` (`id_peng`, `spt_id`, `nama`, `nip`, `pangkat`, `eselon`, `jabatan`, `bayar`, `tahun`) VALUES
(1, '5d991a25e9d6f', 'MUHAMMAD DIS, SE', '19650401 200604 1 003', 'Penata III/c', '0', 'Ka. UPT Peralatan & Pengujian', '', 0000),
(2, '5d991a25e9d6f', 'MUHAMMAD DIS, SE', '19650401 200604 1 003', 'Penata III/c', '0', 'Ka. UPT Peralatan & Pengujian', '', 0000);
...
--
ALTER TABLE `m_pegawai`
  ADD CONSTRAINT `f_eselon` FOREIGN KEY (`eselon_id`) REFERENCES `m_eselon` (`id_eselon`) ON UPDATE NO ACTION,
