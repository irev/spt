...
--
-- Host: 127.0.0.1
-- Generation Time: 14 Okt 2019 pada 00.27
...
('0', 'I', 'THL', 'THL', '500', '1000', '1500', '2000', 2019),
...
('7', 'II', 'Pengatur', 'II/c', '1000', '2000', '3000', '4000', 2019),
...
(8, 'WILDAN, SH. M.Si', '19690314 199003 1 002', 'Sekretaris', '', '0', 0, 2019),
(9, 'ALIN MARIANA, Amd', '19780419 201101 2 001', 'Bendahara', '', '0', 0, 2019),
(10, 'NASRIL, ST, MT', '19760120 200312 1007', 'Kasubag Umum', '', '0', 0, 2019);
...
(3, 'Kinali', 'Kinali', 'Pasaman Barat', 'Sumatera Barat', 20, '1', 0, 'Dalam');
...
('5d991a25e9d6f', '090/12/SPT/DPUPR/2019', '900/12/SPPD/DPUPR/2019', 'HENNY FERNIZA, ST. MT', '1981102 2200604 2 007', 'Pembina IV/a', 'Pembina IV/a', 'Kepala Dinas', 'Maksud dan tujuan spt', 'BA  8036 S', 3, 'Kinali', 1, '2019-10-16', '2019-10-21', '2019', 'Simpang Empat', '0000-00-00', 'Ka. UPT Peralatan & Pengujian', 'MUHAMMAD DIS, SE', 'Pengatur II/c', '19650401 200604 1 003', 'DPA Dinas Pekerjaan Umum & Penataan Ruang Kab. Pasaman Barat Tahun Anggaran 2019', 1, '', '2019-10-06 05:33:09', '2019-10-14 04:32:24', 'Simpang Empat', '0000-00-00', 'MUHAMMAD DIS, SE', '19650401 200604 1 003', 'Pengatur II/c', 'Ka. UPT Peralatan & Pengujian', 'dalam', 2019),
('5d991a9252cbc', '090', '900', 'HENNY FERNIZA, ST. MT', '1981102 2200604 2 007', 'Pembina IV/a', 'Pembina IV/a', 'Kepala Dinas', 'kj', 'BA  8036 S', 0, 'Padang', 3, '2019-10-01', '2019-10-06', '2019', 'Simpang Empat', '2019-10-06', 'Kepala Dinas', 'HENNY FERNIZA, ST. MT', 'Pembina IV/a', '1981102 2200604 2 007', 'DPA Dinas Pekerjaan Umum & Penataan Ruang Kab. Pasaman Barat Tahun Anggaran 2019', 1, '', '2019-10-06 05:34:58', '2019-10-14 04:32:28', 'Simpang Empat', '2019-10-07', 'HENNY FERNIZA, ST. MT', '1981102 2200604 2 007', 'Pembina IV/a', 'Kepala Dinas', '', 2019),
...
--
ALTER TABLE `m_pegawai`
  MODIFY `id_peg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `spt_pengikut`
  MODIFY `id_peng` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
