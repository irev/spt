...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Okt 2019 pada 11.15
...
CREATE TABLE `spt_data` (
  ...
  `ttd_sppd_nama` varchar(200) NOT NULL,
...
INSERT INTO `spt_data` (`id_spt`, `no_spt`, `no_sppd`, `nama`, `nip`, `pangkat`, `golongan`, `jabatan`, `maksud`, `transportasi`, `tujuan`, `tgl_berangkat`, `tgl_kembali`, `sumber_dana`, `ttd_tempat`, `ttd_tgl`, `ttd_jabatan`, `ttd_nama`, `ttd_gol`, `ttd_nip`, `beban`, `anggaran`, `ttd_sppd_tempat`, `ttd_sppd_tgl`, `ttd_sppd_jabatan`, `ttd_sppd_nama`, `ttd_sppd_gol`, `ttd_sppd_nip`, `c_date`, `up_date`) VALUES
(1, '090/001/SPT/DPUPR/2019', '900/001/SPPD/DPUPR/2019', 'HENNY FERNIZA, ST, MT', '19811022 200604 2007', '', 'Pembina IV/a', 'Kepala Dinas', 'Menghadiri Rapat Monitoring Dan Evaluasi Percepatan Infrastruktur Propinsi Sumatera Barat', 'BA 30 S', 'Padang', '2019-10-01', '2019-10-05', '2019', 'Simpang Empat', '2019-10-01', 'Kepala Dinas', 'HENNY FERNIZA, ST, MT', 'Pembina IV/a', '19811022 200604 2007', '', '', '', '0000-00-00', '', '', '', '', '2019-10-01 19:32:49', '2019-10-01 22:00:40');
...
INSERT INTO `spt_pengikut` (`no_spt`, `spt_id`, `nama`, `nip`, `pangkat`, `jabatan`, `bayar`) VALUES
