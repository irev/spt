...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?= base_url('asset/theme') ?>/assets/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?= base_url('asset/theme') ?>/assets/css/ace-part2.min.css" />
		<![endif]-->
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-or-login center">
												<span class="bigger-110"><?= date('d M Y') ?></span>
											</div>
								...
								<div id="forgot-box" class="forgot-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="space-6"></div>
											<p>
												Isi email anda untuk mendapatkan password baru.
											</p>
											...
											<form>
												<fieldset>
													...
													<label class="block">
														...
														<span class="lbl">
															Saya Sepakat, sudah membaca dan dengan sadar menyetujui semua isi yang tercantum pada
