...
?>
    ...
    echo '<option value="' . $peg['id_peg'] . '">' . $peg['nama'] . ' ▶ ' . $peg['nip'] . ' ▶ ' . $peg['jabatan'] . ' ▶ ' . $peg['golongan'] . '</option>';
																					...
																					<div class="form-group">
																						...
																						<div class="col-sm-9">
																							<input readonly type="text" id="ttd_nip" placeholder="nip ttd spt" class="nip col-xs-10 col-sm-5 col-md-12 meedun-input" name="ttd_nip" value="<?=$addttd_nip?>">
																							<div class="bar"></div>
																						</div>
																					</div>
...
<div class="col-md-6">
<h3 class="header smaller lighter blue"><i class="fa fa-info"></i> Perhitungan Mengadakan Pekerjaan</h3>
