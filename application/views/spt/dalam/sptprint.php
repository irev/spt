...
<title>SPT DINAS PEKERJAAN UMUM DAN PENATAAN RUANG</title>
</head>
<style type="text/css">
           ...
           <br>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <h3><u><b style="font-weight: bolder;"><?= $spt_dalam->ttd_nama ?></b></u></h3><?= $spt_dalam->ttd_gol ?><br/><?= $spt_dalam->ttd_nip ?>
                </td>
                </tr>
            </table>
            ...
            <table class="table-konten" border="1" style="font-size:12pt;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="noline-lr">:<br>:<br>:</td>
                        <td>&nbsp;<?= $spt_dalam->ttd_tempat ?><br>&nbsp;<?= $spt_dalam->tujuan ?><br>&nbsp;<?= $spt_dalam->transportasi ?></td>
                    </tr>
                    <tr>
                        <td class="noborder-r nomor-center">4.</td>
                    ...
                    <tr>
                        ...
                        <td class="noline-lr">Dari Tanggal<br>s.d Tanggal</td>
                        <td class="noline-lr">:<br>:</td>
                        <td> &nbsp;<?= LONGE_DATE_INDONESIA($spt_dalam->tgl_berangkat) ?><br>&nbsp;<?= LONGE_DATE_INDONESIA($spt_dalam->tgl_kembali) ?></td>
                    </tr>
                    <tr>
                        <td class="noborder-r nomor-center">6.</td>
           ...
           <br>
            <table class="table-konten" border="1">       
                    <tr>
                        ...
                        <td width="1%">:</td>
                        <td width="48%"><?= $spt_dalam->beban ?><!--textarea name="input_pasal_anggaran" onkeyup="textAreaAdjust(this)" rows="4" cols="150" style="resize: none;">DPA Dinas Pekerjaan Umum & Penataan Ruang Kab. Pasaman Barat Tahun Anggaran 2019</textarea--></td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td><?= $spt_dalam->anggaran ?><!--input type="text" name="input_golongan"--></td>
                    </tr>
                    <tr>
                        <td class="noborder-r nomor-center">8.</td>
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <?= $spt_dalam->ttd_sppd_tempat ?>,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= LONGE_DATE_INDONESIA($spt_dalam->ttd_sppd_tgl) ?><br/><?= $spt_dalam->ttd_sppd_jabatan ?>,<br><br><br><br><br><br>


                    <h3><u> <?= $spt_dalam->ttd_sppd_nama ?></u></h3><?=  $spt_dalam->ttd_sppd_gol ?><br/>Nip. <?= $spt_dalam->ttd_sppd_nip ?>
                </td>
                </tr>
            </table>
            ...
            <table class="table-konten" border="1">
                    <tr>
                        <td width="50%" class="border-l">
                            Tiba&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?= $spt_dalam->tujuan ?><br/>
                            Tanggal&nbsp;: <?= LONGE_DATE_INDONESIA($spt_dalam->tgl_berangkat) ?><br><br><br><br>
                        ...
                        <td width="50%" class="border-l">
                            Kembali&nbsp;&nbsp;: <?= $spt_dalam->tujuan ?> <br/>
                            Tanggal&nbsp;&nbsp;&nbsp;: <?= LONGE_DATE_INDONESIA($spt_dalam->tgl_kembali) ?> <br><br><br><br>
                            <p style="text-align: center;">
                                <U>(...................................................)</U><br>
                                NIP. <span style="margin-right: 177px"></span>.
                            </p>
