...
<div class="book">
        ...
        <div class="subpage"><!--HEADER SURAT-->
            <table class="table-header">
                <tbody>
                    <tr> <td rowspan="4"><img src="logo-kab-pasaman-barat2.png" class="logo"></td> <td><h3>PEMERINTAH KABUPATEN PASAMAN BARAT</h3></td></tr>
...
<!--ISI SURAT-->
            <table>
                <tbody>
                    <tr>
                        <td colspan="5" style="text-align: center; border-bottom-color: #fff;"><u><h3>SURAT PERINTAH TUGAS</h3></u></td>
                    </tr>
                     <tr>
                        <td colspan="5" style="text-align: center;">Nomor:090/<input type="text" name="nomo_sppd" style=" width:35px;">/SPT/DPUPR/<?= date('Y') ?></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table-konten" border="1">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Nama </td>
                        <td >:</td>
                        <td colspan="3">HENNY FERNIZA, ST, MT</td>
                    </tr>
                    <tr>
                        <td class="noborder-r nomor-center">2.</td>
                        <td>Nip</td>
                        <td >:</td>
                        <td>19811022 200604 2007</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td >:</td>
                        <td>Menghadiri Rapat Monitoring Dan Evaluasi Percepatan Infrastruktur Propinsi Sumatera Barat</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td >SUMBER DANA</td>
                        <td >:</td>
                        <td>Anggaran Belanja Langsung Tahun 2019</td>
                    </tr>
                    <tr>
...
<!--ISI SURAT-->
            <table class="table-konten" border="1" style="font-size:12pt;">
                <tbody>
                    ...
                    <tr>
                        <td colspan="5" style="text-align: center; border-bottom-color: #fff;"><u><h3>SURAT PERINTAH PERJALANAN DINAS</h3></u></td>
                    </tr>
